...
class MemberDefImpl : public DefinitionMixin<MemberDefMutable>
{
  public:
    ...
    virtual bool isKconfig() const; /** @author Jobayer Ahmmed */
...
class MemberDefAliasImpl : public DefinitionAliasMixin<MemberDef>
{
  public:
     ...
     */
    virtual bool isKconfig() const
    { return getMdAlias()->isKconfig(); }
               ...
               bool inGroup, int indentLevel, const ClassDef *inheritedFrom,const QCString &inheritId) const
{
  ...
  else
  {
     ...
     * @author Jobayer Ahmmed
     */
    if (QCString(m_impl->type) == "kconfig") {
      ol.insertMemberAlignKconfig();
    } else {
  ...
  {
    /**
     * Write 3 spaces after kconfig name.
     * @author Jobayer Ahmmed
     */
    if (!isDefine() && !isKconfig())
    {
      //ol.writeString(" = ");
      ol.writeString(" ");
...
QCString MemberDefImpl::memberTypeName() const
{
  switch (m_impl->mtype)
  {
     ...
     * @author Jobayer Ahmmed
     */
    case MemberType_Kconfig:     return "kconfig";
...
void MemberDefImpl::writeTagFile(TextStream &tagFile,bool useQualifiedName) const
{
  ...
  switch (m_impl->mtype)
  {
     ...
     * @author Jobayer Ahmmed
     */
    case MemberType_Kconfig:     tagFile << "kconfig";     break;
  }
 ...
 * @author Jobayer Ahmmed
 */
bool MemberDefImpl::isKconfig() const
{
  return m_impl->mtype==MemberType_Kconfig;
}
...
{
  bool enabled = m_impl->hasCallGraph &&
...
{
  bool enabled = m_impl->hasCallerGraph &&
         (isFunction() || isSlot() || isSignal()) &&
         Config_getBool(HAVE_DOT);
  if (enabled)
  {
...
CodeSymbolType MemberDefImpl::codeSymbolType() const
{
  switch (memberType())
  {
     ...
     * @author Jobayer Ahmmed
     */
    case MemberType_Kconfig:     return CodeSymbolType::Kconfig;
  }
