...
enum MemberListType
{
   ...
   */
  MemberListType_decKconfigMembers        = 78 + MemberListType_declarationLists,
  MemberListType_docKconfigMembers        = 79 + MemberListType_documentationLists
};
...
constexpr const char *codeSymbolType2Str(CodeSymbolType type)
{
  switch (type)
  {
    ...
    case CodeSymbolType::Kconfig:     return "kconfig"; /** @author Jobayer Ahmmed */
    default:
      return 0;
  }
}
...
enum MemberType
{
  ...
  MemberType_Kconfig /** @author Jobayer Ahmmed */
};
