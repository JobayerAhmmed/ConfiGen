...
static const std::map< std::string, ElementCallbacks > g_elementHandlers =
{
   ...
   */
  { "file/memberdecl/kconfigs",                   { startCb(&LayoutParser::startMemberDeclEntry, MemberListType_decKconfigMembers,
                                                            []() { return compileOptions(QCString("Kconfigs")); }),
                                                    endCb()
                                                  } },
   ...
   * @author Jobayer Ahmmed
   */                                                
  { "file/memberdef/kconfigs",                    { startCb(&LayoutParser::startMemberDefEntry, MemberListType_docKconfigMembers,
                                                            []() { return compileOptions(QCString("Kconfig Documentation")); }),
                                                    endCb()
                                                  } },
